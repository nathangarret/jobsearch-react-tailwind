...
const Footer = () => {
    return (
        <div className='footer p-[5rem] mb-4 bg-blueColor ronded-[20px] gap-8 grid grid-cols-5 m-auto items-center justify-center'>
            <div>
                ...
                <p className="text-white pb-[13px] opacity-70 leading-7">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam tenetur eligendi, aliquam dolor deserunt illum.
                </p>
            </div>
            <div className="grid">
